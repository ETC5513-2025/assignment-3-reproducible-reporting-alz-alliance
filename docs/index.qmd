...
::: columns
::: {.column width="50%"}
![Illustration of startup process](images/method.jpg){width=100%}
:::

::: {.column width="50%"}
### Methods

**1. Why are we researching about startup? -** 11% increase in funding since 2023 and we can say that we are in the year of startup  

**2. Importance of a reliable dataset -** The data should be from a trustworthy source and it should include relevant information  

**3. How do we plan to approach this dataset -**Focus on various sectors and reasons for failure and use R to visualize patterns  

**4. What is our main goal -** Understand the root causes of startup failure and help prevent similar failures in the future  
:::
:::
---
...
::: columns
::: {.column width="60%"}
![](images/overall-reason.png){width=115%}
:::
