...
The U.S. startup ecosystem experienced significant fluctuations in activity, driven by economic cycles and external shocks. From year 2000 onwards, illustrated in the @fig-temporalplot, the number of active startups surged to a peak of 326 in 2015, fueled by a post-2008 recovery that encouraged new ventures, with formations reaching a high of 62 in 2012. However, closures escalated sharply to 61 in 2020, reflecting the economic fallout from the COVID-19 pandemic, which disrupted funding and operations. A decline in formations after 2015 suggests increasing market saturation, while rising closures highlight external pressures. These trends, illustrated in the accompanying plot, underscore the volatile nature of startups, aligning with earlier findings on competition and financial challenges.

```{r label="fig-temporalplot", echo=FALSE}
library(ggplot2)
library(dplyr)
library(tidyr)
